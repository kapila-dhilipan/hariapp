...
#############################################################
"""
    Below function counts the number of request for each day,
    the function groups each request based on it's timestamp and 
    then again groups and counts the number of user's using the primary key
"""

def get_request_count(queryset):
    print(queryset)
